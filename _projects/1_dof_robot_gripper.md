...
<div class="row mt-3 align-items-center">
    <div class="col-sm-5 mt-3 mt-sm-0">
        {% include figure.liquid loading="eager" path="assets/img/bode_plot_placeholder.png" title="System Bandwidth Analysis" class="img-fluid rounded z-depth-1" %}
        <div class="caption mt-2">
            Simulated velocity bandwidth as a function of Gear Ratio (G) and Inertia Ratio (N). <em>(Placeholder: Add the heatmap or Bode plot from dynamics.ipynb)</em>
        </div>
    </div>
...
<div class="row mt-3 align-items-center">
    ...
    <div class="col-sm-7">
        <ul>
            ...
            <li><strong>Current-Based Homing:</strong> Designed a sensorless homing routine that detects physical hard-stops by monitoring current spikes, ensuring consistent calibration without extra limit switches.</li>
        </ul>
    </div>
</div>
